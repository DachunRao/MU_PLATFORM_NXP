...
class PlatformBuilder(UefiBuilder):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("ACTIVE_PLATFORM", "NXP/Embest_iMX8M_2GB/Embest_iMX8M_2GB.dsc", "Platform Hardcoded")
        self.env.SetValue("PRODUCT_NAME", "Embest_iMX8M_2GB", "Platform Hardcoded")
    ...
    def SetPlatformEnvAfterTarget(self):
        ...
        self.env.SetValue("BUILD_OUTPUT_BASE", value, "Computed in Embest_iMX8M_2GB Build")

        # Output FD file
        key = "OUTPUT_FD"
        value = os.path.join(self.env.GetValue("BUILD_OUTPUT_BASE"), "FV", "ClientBios.fd")
        self.env.SetValue(key, value, "Computed in Embest_iMX8M_2GB Build")
